    ...
    : ControllerBase
{
    ...
    [
        ...
        new("altinn:accessmanagement/enduser:connections:fromothers.read",
            "Les systembrukertilganger fra andre", "Read system user access from others",
            "Les systembrukertilganger som andre har opprettet og gitt til denne brukeren eller virksomheten",
            "Read system user access that others have created and granted to this user or organisation",
            Required: false, "Altinn tilgangsstyring"),

        new("altinn:accessmanagement/enduser:connections:fromothers.write",
            "Behandle systembrukertilganger fra andre", "Handle system user access from others",
            "Godkjenn, avvis eller tilbakekall systembrukertilganger som andre har opprettet mot denne brukeren eller virksomheten",
            "Approve, reject or revoke system user access that others have created towards this user or organisation",
            Required: false, "Altinn tilgangsstyring"),

        new("altinn:accessmanagement/enduser:connections:toothers.write",
            "Administrer systembrukertilganger til andre", "Manage system user access to others",
            "Opprett, oppdater og slett systembrukertilganger som denne brukeren eller virksomheten gir til andre systemer",
            "Create, update and delete system user access that this user or organisation grants to other systems",
            Required: false, "Altinn tilgangsstyring"),

        new("altinn:clientdelegations/myclients.read",
            "Les klientdelegeringer", "Read client delegations",
            "Les oversikt over systemer/klienter som har fått delegert tilgang til å handle på vegne av denne brukeren eller virksomheten",
            "Read the list of systems/clients that have been delegated access to act on behalf of this user or organisation",
        ...
        new("altinn:clientdelegations/myclients.write",
            ...
            "Opprett, oppdater og tilbakekall delegeringer til systemer/klienter som handler på vegne av denne brukeren eller virksomheten",
            "Create, update and revoke delegations to systems/clients acting on behalf of this user or organisation",
            Required: false, "Altinn klientdelegering"),
    ];
